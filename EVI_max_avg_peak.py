...
for year in range(2002, 2015):
    for i in range(len(days)-1):
        ...
        image.Array2Tiff(out_name="/home/faizan/HDD1/EVI/%d/Pak_crop.%d.%s_avg_evi_value.tif" % (year,year,m), Array=avg_value)
        #print m
...
for n in range(len(years)):
    ...
    image.Array2Tiff(out_name="/home/faizan/HDD1/EVI/%d/Pak_crop.%d.kharif_avg_evi_value.tif" % (years[n],years[n]), Array=avg_value)
    del avg_value
